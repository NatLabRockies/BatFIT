"""Train ProbParamCNN (NPE with diagonal Gaussian) on SPM discharge data."""
...
def define_model(inp) -> tuple["ProbParamCNN", object]:
    """Instantiate ProbParamCNN and load the signal scaler.
...
def do_training(inp, model, train_data_loader, test_data_loader, scaler_X):
    """Run the CNN NPE training loop.

    :param inp: parsed recipe
    :param model: ProbParamCNN
