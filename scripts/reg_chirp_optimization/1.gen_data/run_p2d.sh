...
yaml_in=${root_dir}/default_exps/p2d_chirp.yaml
folder_save=./data_p2d_chirp
rm -rf $folder_save
...
# Plot a few simulated signals
python plot_all_sol.py -folder_save $folder_save

# ---- nochirp branch (cyc_mode: chargecc) ----
yaml_in=${root_dir}/default_exps/p2d_nochirp.yaml
folder_save=./data_p2d_nochirp
rm -rf $folder_save
